        ...
        <div className="dialog-overlay-home">
          <div className="dialog-home">
            ...
            <table className="table">
              <thead>
                <tr>
                  <th scope="col" className="col-1">Ngày-Giờ Bắt Đầu</th>
                  <th scope="col" className="">Mã Phòng</th>
                  <th scope="col" className="">Số Người Tham Gia</th>
                  <th scope="col" className="">Kết Thúc</th>
                </tr>
              </thead>
              <tbody>
                <tr>
